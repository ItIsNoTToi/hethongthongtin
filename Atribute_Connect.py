...
class Atribute_Connect:
    ...
    def __init__(self, iface):
        ...
        locale_path = os.path.join(
            self.plugin_dir,
            'i18n',
            'Atribute_Connect_{}.qm'.format(locale))
        ...
        self.actions = []
        self.menu = self.tr(u'&Atribute_Connect')
    ...
    def tr(self, message):
        ...
        return QCoreApplication.translate('Atribute_Connect', message)
    ...
    def initGui(self):
        ...
        icon_path = ':/plugins/Atribute_Connect/icon.png'
        self.add_action(
            icon_path,
            text=self.tr(u'Atribute_Connect'),
            callback=self.run,
